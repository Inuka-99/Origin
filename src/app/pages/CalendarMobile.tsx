        ...
        <div className="p-4">
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-text-secondary">View tasks by date</p>
            </div>
          ...
          <div className="bg-surface rounded-lg shadow-sm p-4 mb-4">
            ...
            <div className="grid grid-cols-7 mb-2">
              {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((day, idx) => (
                <div key={idx} className="text-center text-xs font-semibold text-text-secondary py-1">
                  {day}
                </div>
              ))}
            </div>
                    ...
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      {dayEvents.length > 0 && (
                        <div className={`w-1 h-1 rounded-full mt-0.5 ${
                          isSelected ? 'bg-surface' : getPriorityColor(dayEvents[0].priority)
                        }`}></div>
                      )}
                    </div>
                  </button>
          ...
          <div className="mb-4">
            <h3 className="text-base font-semibold mb-3" style={{ fontFamily: 'Space Grotesk, sans-serif', color: 'var(--text-primary)' }}>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-text-secondary mb-2">{event.project}</p>
                        <span className="inline-block px-2 py-1 bg-surface-sunken rounded text-xs font-medium text-text-secondary">
